...
public class CallDetail {
    ...
    public String toString() {
        return "CallDetail [ucid=" + ucid + ", createTime=" + createTime + ", callId=" + callId + ", callingParty=" + callingParty + ", calledParty=" + calledParty + ", answeringParty="
            + answeringParty + ", OrigCalling=" + OrigCalling + ", Type=" + Type + ", agent=" + agent + ", extention=" + extention + ", lastDirection=" + lastDirection + ", skill=" + skill
            + ", trunk=" + trunk + ", ringTime=" + ringTime + ", DialedTime=" + DialedTime + ", EstablishTime=" + EstablishTime + ", endTime=" + endTime + ", uui=" + uui + ", ngpUserId=" + ngpUserId
            + "]";
    }
